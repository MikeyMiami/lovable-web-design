...
- **Messaging config** — twilio_number, twilio_messaging_service_sid, call_forwarding_number (the client's real phone the Twilio number rings through to; editable per client over time), sending_subdomain, dkim_status.
