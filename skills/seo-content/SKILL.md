...
- **Homepage** — talks directly to the searcher (what you do, how fast, where); each secondary category gets an H2 + **300–400 words** + an editorial link to its category page (`40-page:119-120`).
