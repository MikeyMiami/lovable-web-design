...
| SVC-2b-board / 4 / 5 | Photo-Board reads `by_service` to pre-fill service-page slots (auto-suggest matching-service photos first, then broad pool; keep work/services back-compat) · Assets tab | additive UI | PLANNED (SVC-2b-board next). Scope: `docs/phase-structured-services-scope.md` |
